...
3. [Tweak CommandLine class since parsing takes place in main.] (https://github.com/cs100/assignment-rshell/issues/5)                                                  -->   Jorge
4. [Probably will need to reference Executable class in main to create vector of executables.]                    
5. Implement unit testing for execvp process and parsing                                                        
6. Implement integration testing for execvp process and parsing.                                              
